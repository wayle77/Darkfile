...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mAuthor_HK-OFFICIAL')
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/HK-DATA')
	except:pass
	try:os.system('touch .prox.txt')
	except:pass
	try:os.system('clear')
	except:pass
	muhammad_basari(f'\n\t{x}{h}⟺ Hello, Welcome Termux User,By HK-OFFICIAL ⟺{x}')
	time.sleep(3)
	login()
